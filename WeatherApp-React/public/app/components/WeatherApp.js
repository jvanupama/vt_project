define(function (require) {
    ...
    //var react-toggle-button = require('react-toggle-button');
    ...
    var WeatherApp = React.createFactory(React.createClass({
        ...
        render: function() {
            ...
            if (this.state.weatherData) {
                return div(null,
                    SearchBox({defaultValue: this.props.city, onCityChanged: this.onCityChanged, onUnitChanged: this.onUnitChanged}),
                    // Weather Title
                    WeatherTitle({
		    ...
		    // Toggle Units
		   //TogBox({ defaultValue: 'c', onUnitChanged:}),
